...
public class Withdraw implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == DoneButton) {
			try {
				if(login.Who == 1 && Integer.parseInt(BalanceField.getText()) <= 2000 && MainAccount.Account1.Balance-Integer.parseInt(BalanceField.getText())>=0 && Integer.parseInt(BalanceField.getText()) >= 0) {
					MainAccount.Account1.Balance -= Double.parseDouble(BalanceField.getText());
					new Operations();
					frame.dispose();
				}
				else if(login.Who == 2 && Integer.parseInt(BalanceField.getText()) <= 2000 && MainAccount.Account2.Balance-Integer.parseInt(BalanceField.getText())>=0 && Integer.parseInt(BalanceField.getText()) >= 0) {
